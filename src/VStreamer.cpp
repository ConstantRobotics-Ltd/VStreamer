...
bool VStreamerParams::encode(uint8_t* data, int bufferSize, int& size, VStreamerParamsMask* mask)
{
    ...
    */
    ...
    if (mask == nullptr)
    {
        ...
        memcpy(&data[pos], &enable, sizeof(bool)); pos += sizeof(bool);
        data[3] |= (1<<7);
        ...
        memcpy(&data[pos], &width, sizeof(int)); pos += sizeof(int);
        data[3] |= (1<<6);
        ...
        memcpy(&data[pos], &height, sizeof(int)); pos += sizeof(int);
        data[3] |= (1<<5);
        ...
        memcpy(&data[pos], ip.c_str(), ip.size() + 1); pos += ip.size() + 1;
        data[3] |= (1<<4);
        ...
        memcpy(&data[pos], &port, sizeof(int)); pos += sizeof(int);
        data[3] |= (1<<3);
        ...
        memcpy(&data[pos], user.c_str(), user.size() + 1); pos += user.size() + 1;
        data[3] |= (1<<2);
        ...
        memcpy(&data[pos], suffix.c_str(), suffix.size() + 1); pos += suffix.size() + 1;
        data[3] |= (1<<1);
        ...
        memcpy(&data[pos], &minBitrateKbps, sizeof(int)); pos += sizeof(int);       
        data[3] |= (1<<0);
        ...
        memcpy(&data[pos], &maxBitrateKbps, sizeof(int)); pos += sizeof(int);
        data[4] |= (1<<7);
        ...
        memcpy(&data[pos], &bitrateKbps, sizeof(int)); pos += sizeof(int);
        data[4] |= (1<<6);
        ...
        memcpy(&data[pos], &bitrateMode, sizeof(int)); pos += sizeof(int);
        data[4] |= (1<<5);
        ...
        int tempFps = fps;
        memcpy(&data[pos], &tempFps, sizeof(int)); pos += sizeof(int);
        data[4] |= (1<<4);
        ...
        memcpy(&data[pos], &gop, sizeof(int)); pos += sizeof(int);
        data[4] |= (1<<3);
        ...
        memcpy(&data[pos], &h264Profile, sizeof(int)); pos += sizeof(int);
        data[4] |= (1<<2);
        ...
        memcpy(&data[pos], &jpegQuality, sizeof(int)); pos += sizeof(int);
        data[4] |= (1<<1);
        ...
        memcpy(&data[pos], codec.c_str(), codec.size() + 1); pos += codec.size() + 1;
        data[5] |= (1<<7);
        ...
        memcpy(&data[pos], &fitMode, sizeof(int)); pos += sizeof(int);
        data[5] |= (1<<6);
        ...
        memcpy(&data[pos], &cycleTimeMksec, sizeof(int)); pos += sizeof(int);
        data[5] |= (1<<5);
        ...
        memcpy(&data[pos], password.c_str(), password.size() + 1); pos += password.size() + 1;
        data[5] |= (1<<4);
        ...
        memcpy(&data[pos], &overlayMode, sizeof(bool)); pos += sizeof(bool);
        data[5] |= (1<<3);
        ...
        memcpy(&data[pos], &type, sizeof(int)); pos += sizeof(int);
        data[5] |= (1<<2);
        ...
        memcpy(&data[pos], &tempCustom1, sizeof(int)); pos += sizeof(int);
        data[5] |= (1<<1);
        ...
        memcpy(&data[pos], &tempCustom2, sizeof(int)); pos += sizeof(int);
        data[5] |= (1<<0);
        ...
        memcpy(&data[pos], &tempCustom3, sizeof(int)); pos += sizeof(int);
        data[6] |= (1<<7);
...
bool VStreamerParams::decode(uint8_t* data, int dataSize)
{
    ...
    */
    ...
    if (checkBit(data[3], 7))
    {
        if (dataSize < pos + 1)
            return false;
        memcpy(&enable, &data[pos], sizeof(bool)); pos += sizeof(bool);
    }
    else
    {
        enable = false;
    ...
    if (checkBit(data[3], 6))
    {
        if (dataSize < pos + sizeInt)
            return false;
        memcpy(&width, &data[pos], sizeInt); pos += sizeInt;
    }
    else
    {
        width = 0;
    ...
    if (checkBit(data[3], 5))
    {
        if (dataSize < pos + sizeInt)
            return false;
        memcpy(&height, &data[pos], sizeInt); pos += sizeInt;
    }
    else
    {
        height = 0;
    ...
    if (checkBit(data[3], 3))
    {
        if (dataSize < pos + sizeInt)
            return false;
        memcpy(&port, &data[pos], sizeInt); pos += sizeInt;
    }
    else
    {
        port = 0;
    ...
    if (checkBit(data[3], 0))
    {
        if (dataSize < pos + sizeInt)
            return false;
        memcpy(&minBitrateKbps, &data[pos], sizeInt); pos += sizeInt;
    }
    else
    {
        minBitrateKbps = 0;
    ...
    if (checkBit(data[4], 7))
    {
        if (dataSize < pos + sizeInt)
            return false;
        memcpy(&maxBitrateKbps, &data[pos], sizeInt); pos += sizeInt;
    }
    else
    {
        maxBitrateKbps = 0;
    ...
    if (checkBit(data[4], 6))
    {
        if (dataSize < pos + sizeInt)
            return false;
        memcpy(&bitrateKbps, &data[pos], sizeInt); pos += sizeInt;
    }
    else
    {
        bitrateKbps = 0;
    ...
    if (checkBit(data[4], 5))
    {
        if (dataSize < pos + sizeInt)
            return false;
        memcpy(&bitrateMode, &data[pos], sizeInt); pos += sizeInt;
    }
    else
    {
        bitrateMode = 0.0f;
    ...
    if (checkBit(data[4], 4))
    {
        if (dataSize < pos + sizeInt)
            return false;
        int tempFps;
        memcpy(&tempFps, &data[pos], sizeInt); pos += sizeInt;
        fps = tempFps;
    }
    else
    {
    ...
    if (checkBit(data[4], 3))
    {
        if (dataSize < pos + sizeInt)
            return false;
        memcpy(&gop, &data[pos], sizeInt); pos += sizeInt;
    }
    else
    {
        gop = 0;
    ...
    if (checkBit(data[4], 2))
    {
        if (dataSize < pos + sizeInt)
            return false;
        memcpy(&h264Profile, &data[pos], sizeInt); pos += sizeInt;
    }
    else
    {
        h264Profile = -1;
    ...
    if (checkBit(data[4], 1))
    {
        if (dataSize < pos + sizeInt)
            return false;
        memcpy(&jpegQuality, &data[pos], sizeInt); pos += sizeInt;
    }
    else
    {
        jpegQuality = 0;
    ...
    if (checkBit(data[5], 6))
    {
        if (dataSize < pos + sizeInt)
            return false;
        memcpy(&fitMode, &data[pos], sizeInt); pos += sizeInt;
    }
    else
    {
        fitMode = -1;
    ...
    if (checkBit(data[5], 5))
    {
        if (dataSize < pos + sizeInt)
            return false;
        memcpy(&cycleTimeMksec, &data[pos], sizeInt); pos += sizeInt;
    }
    else
    {
        cycleTimeMksec = -1;
    ...
    if (checkBit(data[5], 3))
    {
        if (dataSize < pos + 1)
            return false;
        memcpy(&overlayMode, &data[pos], sizeof(bool)); pos += sizeof(bool);
    }
    else
    {
        overlayMode = false;
    ...
    if (checkBit(data[5], 2))
    {
        if (dataSize < pos + sizeInt)
            return false;
        memcpy(&type, &data[pos], sizeInt); pos += sizeInt;
    }
    else
    {
        type = -1;
    ...
    if (checkBit(data[5], 1))
    {
        if (dataSize < pos + sizeInt)
            return false;
        int tempCustom1;
        memcpy(&tempCustom1, &data[pos], sizeInt); pos += sizeInt;
        custom1 = tempCustom1;
    }
    else
    {
    ...
    if (checkBit(data[5], 0))
    {
        if (dataSize < pos + sizeInt)
            return false;
        int tempCustom2;
        memcpy(&tempCustom2, &data[pos], sizeInt); pos += sizeInt;
        custom2 = tempCustom2;
    }
    else
    {
    ...
    if (checkBit(data[6], 7))
    {
        if (dataSize < pos + sizeInt)
            return false;
        int tempCustom3;
        memcpy(&tempCustom3, &data[pos], sizeInt); pos += sizeInt;
        custom3 = tempCustom3;
    }
    else
    {
